        ...
        <div className="lg:col-span-2 xl:col-auto">
          <div className="flex flex-col justify-between w-full h-full bg-gray-100 px-14 rounded-2xl py-14 dark:bg-trueGray-800">
            <p className="text-2xl leading-normal ">
              Candor has transformed our <Mark>communications</Mark>. What used to take hours
              of back and forth is now minutes.
            </p>

            <Avatar
              image={userOneImg}
              name="Sarah Steiner"
              title="Thirdstone Properties"
            />
          </div>
        </div>
        <div className="">
