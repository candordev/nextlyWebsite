...
import propTechImg from "../../public/img/propTech.png";

export const Hero = () => {
  return (
    <>
      <Container className="flex flex-wrap">
        <div className="flex items-center w-full lg:w-5/12">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-5xl xl:leading-tight dark:text-white">
              An AI Assistant for Property Managers
            </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              Candor helps property managers save time and increase revenue.
              Automate tenant communication, maintenance requests, application
              reviews, and more.
            </p>
...
const Accomplishment = ({ verb, noun }: AccomplishmentProps) => {
  return (
    <div className="flex flex-col items-center">
      <span className="text-gray-400 dark:text-gray-400 text-l font-medium">
        {verb}
      </span>
      <span className="pt-2 text-gray-400 dark:text-gray-400 text-3xl font-bold">
        {noun}
      </span>
    </div>
  );
